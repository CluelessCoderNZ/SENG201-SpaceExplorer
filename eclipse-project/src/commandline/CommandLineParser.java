...
public class CommandLineParser {
  ...
  /**
   * creates a CommandLineParser that sends input and output to the given streams.
   * @param output PrintStream to send output to
   * @param input InputStream to get input from
   */
  ...
  /**
   * prints a message to the parser's PrintStream.
  ...
  /**
   * prints an error to the parser's PrintStream.
