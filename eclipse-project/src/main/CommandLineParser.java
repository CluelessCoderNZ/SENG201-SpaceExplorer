...
public class CommandLineParser {
   ...
   */
    ...
    do {
      ...
      if(value.length() > maxLength) {
        printError(String.format("Text must be less than or equal to %d characters, currently %d.", maxLength, value.length()));
        continue;
      }
	...
	/**
	 * Get a boolean from the InputStream. Accepting all-case y/n, 1/0, yes/no, true/false. Repeating on invalid strings.
	 * @param message message to put into output stream
  ...
  /**
	 * Get a selected index from input from list of options. Accepts index of option as well as option string. Repeats on out of bounds and type errors.
	 * @param message message to put into output stream
